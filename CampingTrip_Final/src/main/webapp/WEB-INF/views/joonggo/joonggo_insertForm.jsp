...
<body>
	...
	<!-- 폼 시작 -->
		...
		<div class="row">
			<div class="col title" id="maintitle"><i class="fas fa-plus-circle fa-lg"></i><span> 상품 등록하기</span></div>
			<div class="col"><button type="button" id="submitbtn" onclick="insertForm()" style="float:right;"><span class="align-middle">등록</span></button></div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="col">
				<div class="border" id="tagcol">
					<input class="align-middle" type="text" placeholder="태그를 입력해주세요." style="width: auto; height:35px;" id="tag" autocomplete="off" maxlength="10">
				</div>
			</div>
		</div>
